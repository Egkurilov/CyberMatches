#!/usr/bin/env python3
"""
Финальная рабочая версия main.py с исправленной обработкой дубликатов и транзакций
"""
            ...
            for m in matches:
                ...
                if cleaned_tournament:
                    try:
                        ...
                        print(f"[DEBUG] Ошибка при поиске турнира: {e}")
                        tournament_id = None
                ...
                if liquipedia_match_id:
                    try:
                        ...
                        print(f"[DEBUG] Ошибка при вставке матча: {e}")
                        continue
                else:
